...
$\frac23n^3 + \frac32n^2 + \frac56n$ operacij. Za izračun $Lx$ potrebujemo $n^2$
operacij, za $Ax$ potrebujemo $2n^2$ operacij. Za izračun inverza matrike preko
LU razcepa potrebujemo $2n^3$ operacij.
...
QR razcep je bolj stabilen. Za $A \in \R^{m\times n}$ obstaja enoličen razcep $A = QR$, $Q^TQ =
...
Definiramo $P = I - \frac{2}{w^Tw}ww^T$. $P$ je zrcaljenje prek ravnine z normalo
$w$. $Px$ = $x - \frac{1}{m}(x^Tw)w$, $m = \frac12w^Tw$.
