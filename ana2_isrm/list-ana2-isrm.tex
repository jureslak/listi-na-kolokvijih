...
%
	...
	\begin{enumerate}
		...
		\end{enumerate}
		\item $\int \sqrt{a^2 - x^2}dx \quad t = a\sin{t} \quad dx = a\cos{t}dt \quad t = \arcsin{\frac{x}{a}}$
		\item $\int \sqrt{a^2 + x^2}dx \quad t = a\sh{t} \quad dx=a\ch{t}dt \quad t = \arsh{\frac{x}{a}}$ 
	\end{enumerate}
%
